...
Mostly inheriting everything from the DeployFramework, and overriding
parameters to allow for deployment to a different server
...
class Params(DeployFramework.Params):
    fmeServerUrl = 'http://gienah.dmz'
    fmeServerAuthKey = 'eabbe51cea3c38795ac12dc2c5b334c588673d46'
...
class ConfigsDeployment(DeployFramework.ConfigsDeployment):
    ...
    def deployServerSpecific(self):
        ...
        host=http://arneb
        rootdir=/fmerest/v2/
        token=d8c7340cc774160cbfec7823607d2cfe682e8813
        '''
        params = Params()
